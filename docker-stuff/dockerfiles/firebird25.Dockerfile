...
# -----
# копируем скрипты, открываем порты, ставим права
# -----
EXPOSE 3050/tcp
COPY docker-stuff/default-configs/firebird25/docker-entrypoint.sh ${PREFIX}/docker-entrypoint.sh
# тут были еще скрипты, но я их убрал
RUN chmod +x ${PREFIX}/docker-entrypoint.sh
# тут были еще скрипты, но я их убрал

# -----
# проверка, что firebird жив
# -----
COPY docker-stuff/default-configs/firebird25/docker-healthcheck.sh ${PREFIX}/docker-healthcheck.sh
